"""
marketing_dep.py  –  Marketing department-level dashboard
"""
...
def show():
    ...
    st.markdown("Upload the **Marketing department dataset** to view burnout insights for Marketing employees.")
